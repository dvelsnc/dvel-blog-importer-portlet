...
public class EmailAddressSoap implements java.io.Serializable {
	...
	public EmailAddressSoap(
		java.lang.String address, long classNameId, long classPK,
		long companyId, java.util.Calendar createDate, long emailAddressId,
		java.util.Calendar modifiedDate, boolean primary, long primaryKey,
		int typeId, long userId, java.lang.String userName) {
	...
	public synchronized boolean equals(java.lang.Object obj) {
		...
		if (!(obj instanceof EmailAddressSoap))
			return false;
		...
		_equals =
			true &&
				((this.address == null && other.getAddress() == null) || (this.address != null && this.address.equals(other.getAddress()))) &&
